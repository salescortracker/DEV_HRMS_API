...
namespace BusinessLayer.DTOs
{
    ...
    public class CreateEarlyDepartureRequestDto
    {
        public int EmployeeID { get; set; }
        ...
        public TimeOnly RequestedDepartureTime { get; set; }
    ...
    // ================= UPDATE EARLY DEPARTURE =================

    public class UpdateEarlyDepartureDto
    {
        public int EarlyDepartureRequestID { get; set; }
    ...
    public class BulkApproveRejectEarlyDepartureDto
    {
        public List<int> EarlyDepartureRequestIds { get; set; } = new();
    ...
    public class EarlyDepartureApprovalListDto
    {
        public int EarlyDepartureRequestId { get; set; }
    ...
    public class EarlyDepartureListDto
    {
        public int EarlyDepartureRequestId { get; set; }
